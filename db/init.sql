...
-- -----------------------------------------------------
-- Table `cliserver`.`KOrder`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cliserver`.`KOrder` ;

CREATE TABLE IF NOT EXISTS `cliserver`.`KOrder` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cliserver`.`OrderItem` (
  ...
  CONSTRAINT `fk_OrderItem_Order1`
    ...
    REFERENCES `cliserver`.`KOrder` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
